...
- Forbidden: full solutions, coaching tips, evaluative praise ("Good", "Exactly"), explaining why their approach was strong, rubric filenames in user-facing text.
...
- Forbidden: template solutions, coaching, evaluative praise or correctness summaries, internal mechanics in user-facing messages.
